...
#   InterSubMod/.claude/skills/cycle-init/_cycle_init.py
# parents[0] = cycle-init, [1] = skills, [2] = .claude, [3] = InterSubMod
...
PITFALLS_TABLE = REPO_ROOT / ".claude" / "skills" / "run-evaluator" / "pitfalls_table.json"
