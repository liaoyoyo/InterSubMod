#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""screenshot_all.py — Validate the V3 generated PPTX (12 slides精簡版).
...
Per-slide checks:
    1. notes non-empty AND >= 500 chars (HARD FAIL otherwise; V3 stricter than v2)
...
PPTX_PATH = OUT_DIR / "20260429_Self_Phasing_精簡教授報告_v3.pptx"
