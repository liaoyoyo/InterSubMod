...
(function(){var host=el('threeaxis');if(!host)return;var dt=D.detail||[];
 ...
 host.innerHTML='<div style="background:#fffbf5;border:1px solid #ffe0a3;border-radius:5px;padding:4px 9px;margin-bottom:6px;font-size:10.5px;color:#a37200">🏷️ characterization · single-bulk · 6樣本標籤弱(census) · <b>無 CN 控制</b> · pseudoreplication(真 n=7) · <b>L3/⭐3</b></div>'
