...
![QUAL 分布](../../figures/2026/01/phase1_plots/exp1_1_qual_distribution.png)
...
![AF 分布](../../figures/2026/01/phase1_plots/exp1_2_af_distribution.png)
...
![Strand Bias](../../figures/2026/01/phase1_plots/exp1_3_strand_bias.png)
...
![Regional Clustering](../../figures/2026/01/phase1_plots/exp1_4_regional_clustering.png)
...
![Combined Features](../../figures/2026/01/phase1_plots/exp1_5_combined_features.png)
...
| 圖表 | 說明 |
|:---|:---|
| [exp1_1_qual_distribution.png](../../figures/2026/01/phase1_plots/exp1_1_qual_distribution.png) | QUAL 分布與箱形圖 |
| [exp1_2_af_distribution.png](../../figures/2026/01/phase1_plots/exp1_2_af_distribution.png) | AF 分布、KDE、範圍分析 |
| [exp1_3_strand_bias.png](../../figures/2026/01/phase1_plots/exp1_3_strand_bias.png) | Strand Bias 箱形圖 |
| [exp1_4_regional_clustering.png](../../figures/2026/01/phase1_plots/exp1_4_regional_clustering.png) | 區域聚集分布與 TP 比例 |
| [exp1_5_combined_features.png](../../figures/2026/01/phase1_plots/exp1_5_combined_features.png) | 特徵 AUC、重要性、CV 結果 |

### 分析腳本

- 位置: [scripts/analysis/legacy/methylation_f1_optimization/phase1_analysis.py](/big8_disk/liaoyoyo2001/InterSubMod/scripts/analysis/legacy/methylation_f1_optimization/phase1_analysis.py)
- 可重複執行驗證結果
