...
```bash
# 修改 scripts/run_vcf_all_snv.sh 中的 METRICS 變數
METRICS="BERNOULLI"
...
- [可行性分析報告](../../../../concepts/2025/12/20251222_Bernoulli_01.md)
- [實作計畫文件](../../../../plans/2025/12/20251222_Bernoulli_Implementation_Plan_01.md)
- [距離方法比較文件](../../../../solutions/investigation/2025/12/20251222_distance_methods_analysis_01.md)
