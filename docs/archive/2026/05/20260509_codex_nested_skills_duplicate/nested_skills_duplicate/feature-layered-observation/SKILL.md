...
- 本 skill 是從 `.claude/skills/feature-layered-observation` 遷移到 `.agents/skills/feature-layered-observation` 的 Codex 版本；`.claude` 版本保留為 legacy source，不在本 skill 內修改。
