...
**Command:**
```bash
./scripts/run_vcf_all_snv.sh --mode baseline --threads 32
```
...
**Command:**
```bash
./scripts/run_vcf_all_snv.sh --mode all-with-window --threads 32
```
...
| `scripts/run_vcf_all_snv.sh` | Added baseline and all-with-window modes |
...
- [x] `run_vcf_all_snv.sh` successfully executes:
