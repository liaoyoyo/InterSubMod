...
# 3. 大規模測試（完整資料）
./scripts/run_vcf_all_snv.sh --mode all-with-clustering --threads 64
...
**文件狀態**：完成  
**配套文件**：[研究主軸說明](../../../concepts/2025/12/20251218_clustering_evolution_research_overview_01.md)、[開發實作指南](20251218_clustering_evolution_implementation_guide_01.md)
