...
| 整合測試 | `run_full_vcf_test.sh --mode chr19-verification --no-plots` |
...
```bash
# 單點驗證
./scripts/run_full_vcf_test.sh --mode chr19-verification --no-plots

# 完整流程
./scripts/run_full_vcf_test.sh --mode all-with-w1000 --threads 120
```
