#!/usr/bin/env python3
"""LOSO 5-fold CV using RandomForestClassifier (n_estimators=200, max_depth=8, leaf=50)."""
...
import logging
LOGGER = logging.getLogger("loso_RF")
...
OUT_TSV = LOSO_DIR / "data" / "loso_RF_results.tsv"
OUT_FIG = LOSO_DIR / "figures" / "loso_RF_5sample_dF1.png"
OUT_SUMMARY = LOSO_DIR / "intermediate" / "loso_RF_summary.json"
...
def main():
    ...
    summary = {
        ...
        "hyperparameters": {"n_estimators": 200, "max_depth": 8, "min_samples_leaf": 50,
                             "n_jobs": -1, "random_state": PRIMARY_SEED},
    ...
    ax.set_title("LOSO — RandomForestClassifier (n=200, depth=8, leaf=50, seed=42)")
    ax.set_ylabel("ΔF1")
    fig.tight_layout()
