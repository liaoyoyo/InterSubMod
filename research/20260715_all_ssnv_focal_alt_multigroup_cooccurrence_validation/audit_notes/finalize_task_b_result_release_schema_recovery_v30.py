#!/usr/bin/env python3
"""Create or verify Task-B release receipts for the v30 recovery chain."""
...
SCRIPT_DIR = RECOVERY_DIR.parent / "scripts"
for module_dir in (RECOVERY_DIR, SCRIPT_DIR):
    if str(module_dir) not in sys.path:
        sys.path.insert(0, str(module_dir))

import build_all_ssnv_final_report_dataset_schema_recovery_v29 as BUILDER  # noqa: E402
...
RECOVERY_REPORT_BUILDER = (
    RECOVERY_DIR / "build_all_ssnv_report_artifact_schema_recovery_v29.py"
)
EXPECTED_OUTPUTS = {
