#!/usr/bin/env python3
"""Run one read-only strict-command-parity review and create a process attestation."""
...
EVIDENCE_MODULE_PATH = HERE / "attested_release_evidence_v3.py"
ASSEMBLER_PATH = HERE / "assemble_release_source_authority_v13.py"
...
def main() -> int:
    ...
    with BoundArtifactReader() as reader:
        ...
        command = [
            ...
            session_id,
            "--name",
            f"InterSubMod Task-B external Reviewer {reviewer_token} v21 strict command parity",
