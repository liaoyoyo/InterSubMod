#!/usr/bin/env python3
"""Run one read-only v7-consumer-rotation review with process attestation."""
...
EVIDENCE_MODULE_PATH = HERE / "attested_release_evidence_v4.py"
ASSEMBLER_PATH = HERE / "assemble_release_source_authority_v14.py"
...
def main() -> int:
    ...
    with BoundArtifactReader() as reader:
        ...
        command = [
            ...
            session_id,
            "--name",
            f"InterSubMod Task-B external Reviewer {reviewer_token} v21 v7 consumer rotation",
