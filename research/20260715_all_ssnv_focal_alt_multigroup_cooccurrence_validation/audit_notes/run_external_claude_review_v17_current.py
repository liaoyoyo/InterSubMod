#!/usr/bin/env python3
"""Run one current v16 external Claude review with bounded shell usage."""
...
REVIEW_SPECS = {
    "A": {
        "request": (
            HERE
            / "20260718_external_claude_reviewer_A_v16_v5_signer_request.md"
        ),
        "request_sha256": (
            "2e724b13cd4fb16185321be0475f44c89454579824fc1696a3ef35c286c1efc6"
        ),
        "output_prefix": (
            "20260718_external_claude_reviewer_A_v16_v5_signer_output.attempt1"
        ),
        "prior_attempt": {
            "status": (
                "V15_TRANSPORT_SESSION_LIMIT_NOT_A_VERDICT_"
                "AND_SOURCE_SET_SUPERSEDED_BY_V5_FIX"
            ),
            "returncode": 1,
            "result": (
    ...
    "B": {
        "request": (
            HERE
            / "20260718_external_claude_reviewer_B_v16_adversarial_request.md"
        ),
        "request_sha256": (
            "7daf239ffe7c08a96f92ffc13df4497baf8e032937104d9e9f3e957e6bdf3f20"
        ),
        "output_prefix": (
            "20260718_external_claude_reviewer_B_v16_v5_signer_output.attempt1"
        ),
        "prior_attempt": {
            "status": (
                "V15_TRANSPORT_SESSION_LIMIT_NOT_A_VERDICT_"
...
class ReviewRunnerError(RuntimeError):
    """Raised when a current external review cannot be preserved safely."""
...
def main() -> int:
    ...
    command = [
        ...
        session_id,
        "--name",
        f"InterSubMod Task-B external Reviewer {args.reviewer} v16 attempt1",
    ...
    command_record = {
        ...
        "requires_transport_extraction_and_v16_normalization": True,
