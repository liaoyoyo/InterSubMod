...
verify_source_authority() {
    ...
    jq -e '
        ...
        .authority_id == "20260719_all_ssnv_focal_alt_task_b_release_v6_command_parity" and
    ...
    jq -e \
        ...
        .public_key.path == "/bip7_disk/liaoyoyo2001/.config/intersubmod_release_authority/20260719_all_ssnv_v9_post_reboot_bootstrap/ed25519_public.pem" and
        .public_key.sha256 == "cf6b8b5eef26e3a53dc6b40d7cd98b6a809257c324322cdbe9dee4e81fdd81b5" and
