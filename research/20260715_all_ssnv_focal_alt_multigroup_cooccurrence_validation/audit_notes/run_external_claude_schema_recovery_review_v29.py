#!/usr/bin/env python3
"""Run and preserve the read-only external Claude v29 remediation review."""
...
PROMPT = AUDIT_ROOT / "20260724_external_claude_schema_recovery_review_v29_prompt.md"
SCHEMA = AUDIT_ROOT / "20260724_external_claude_schema_recovery_review_v29.schema.json"
ENVELOPE = (
    AUDIT_ROOT
...
STDERR = (
    AUDIT_ROOT
    / "20260724_external_claude_schema_recovery_review_v29.claude_cli.stderr.txt"
)
SESSION_ID = "8e6d6be7-d3bd-400d-ae0a-43a7960deec3"
...
def main() -> int:
    ...
    command = [
        ...
        SESSION_ID,
        "--name",
        "InterSubMod Task-B schema recovery external reviewer v29",
