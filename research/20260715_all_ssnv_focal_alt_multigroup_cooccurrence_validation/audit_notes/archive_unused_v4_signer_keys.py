#!/usr/bin/env python3
"""Archive four unused v4 signer key directories without deletion or overwrite."""
...
LEDGER = HERE / "20260718_unused_v4_signer_key_archive.v1.jsonl"
PRIOR_ARCHIVE_LEDGER = HERE / "20260718_unused_v3_signer_key_archive.v1.jsonl"
...
ENTRIES = (
    {
        ...
        "archive": Path(
            ...
            "20260718_all_ssnv_v5_summary_hotfix_unused_v4_terminal_path_unbound_01"
        ),
        "target": Path(
    ...
    },
    {
        ...
        "archive": Path(
            "/bip7_disk/liaoyoyo2001/.config/intersubmod_result_release_authority/"
            "archive/20260717_all_ssnv_result_v2_unused_v4_terminal_path_unbound_01"
        ),
        "target": Path(
    ...
    },
    {
        ...
        "archive": Path(
            "/bip7_disk/liaoyoyo2001/.config/intersubmod_report_release_authority/"
            "archive/20260717_all_ssnv_report_v2_unused_v4_terminal_path_unbound_01"
        ),
        "target": Path(
            "/big7_disk/liaoyoyo2001/InterSubMod/research/"
            "20260715_all_ssnv_focal_alt_multigroup_cooccurrence_validation/"
    ...
    },
    {
        ...
        "archive": Path(
            ...
            "20260718_positional_singleton_v1_unused_v4_terminal_path_unbound_01"
        ),
        "target": Path(
            "/big7_disk/liaoyoyo2001/InterSubMod/research/"
            "20260715_all_ssnv_focal_alt_multigroup_cooccurrence_validation/"
...
def preflight(entry: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "reason": (
            ...
            "CANONICAL_SIGNATURE_PATH_FALSE_SUCCESS_WINDOW"
        ),
