#!/usr/bin/env python3
"""Archive four unused v3 signer key directories without deletion or overwrite."""
...
LEDGER = HERE / "20260718_unused_v3_signer_key_archive.v1.jsonl"
PRIOR_ARCHIVE_LEDGER = HERE / "20260718_unused_v2_signer_key_archive.v2.jsonl"
...
ENTRIES = (
    {
        ...
        "archive": Path(
            ...
            "20260718_all_ssnv_v5_summary_hotfix_unused_v3_digest_unbound_signer_01"
        ),
        "target": Path(
    ...
    },
    {
        ...
        "archive": Path(
            "/bip7_disk/liaoyoyo2001/.config/intersubmod_result_release_authority/"
            "archive/20260717_all_ssnv_result_v2_unused_v3_digest_unbound_signer_01"
        ),
        "target": Path(
    ...
    },
    {
        ...
        "archive": Path(
            "/bip7_disk/liaoyoyo2001/.config/intersubmod_report_release_authority/"
            "archive/20260717_all_ssnv_report_v2_unused_v3_digest_unbound_signer_01"
        ),
        "target": Path(
            "/big7_disk/liaoyoyo2001/InterSubMod/research/"
            "20260715_all_ssnv_focal_alt_multigroup_cooccurrence_validation/"
    ...
    },
    {
        ...
        "archive": Path(
            ...
            "20260718_positional_singleton_v1_unused_v3_digest_unbound_signer_01"
        ),
        "target": Path(
            "/big7_disk/liaoyoyo2001/InterSubMod/research/"
            "20260715_all_ssnv_focal_alt_multigroup_cooccurrence_validation/"
...
def preflight(entry: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "reason": (
            "UNUSED_AFTER_INTERNAL_REVIEW_FOUND_APPROVAL_DIGEST_HANDOFF_"
            "KEY_DIRECTORY_LIFECYCLE_AND_FAILURE_STATE_GAPS"
        ),
