...
MODULE_PATH = TOPIC_ROOT / "audit_notes" / "normalize_external_source_review_v13.py"


def load_module() -> ModuleType:
    spec = importlib.util.spec_from_file_location(
        "normalize_external_source_review_v13", MODULE_PATH
    )
...
def valid_payload(module: ModuleType) -> dict[str, object]:
    return {
        ...
        "reviewer_label": "External Reviewer A v13",
