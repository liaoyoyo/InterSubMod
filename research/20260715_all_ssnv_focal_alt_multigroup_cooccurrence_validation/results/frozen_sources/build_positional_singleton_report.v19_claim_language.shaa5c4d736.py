...
CANONICAL_PYTEST_XML = (
    TOPIC_ROOT
    / "logs"
    / "pytest_full_pre_supplemental_v19_claim_language.xml"
)
TEST_EVIDENCE_MANIFEST = (
    TOPIC_ROOT / "logs" / "supplemental_report_test_evidence.v3.json"
)
...
TEST_EVIDENCE_PUBLIC_KEY = Path(
    ...
    "20260718_positional_singleton_report_v3/ed25519_public.pem"
)
...
TEST_EVIDENCE_PUBLIC_KEY_SHA256 = (
    "1a87955b536cf2945e8fbd5e5d433a0e851e530cd607a58f0210632a37f76ce1"
)
TEST_EVIDENCE_AUTHORITY_ID = (
    "20260718_positional_singleton_supplemental_test_evidence_v3"
)
