...
PILE = "/big7_disk/liaoyoyo2001/big7_disk_output/bip8_output_archive/research_rounds/20260307_hcc1395_to_pilot_1/step02_benchmark_clairs_to"
...
CLASSES = {
    'TP': f"{PILE}/filtered_snv_tp.vcf.gz",
    'FP': f"{PILE}/filtered_snv_fp.vcf.gz",
    'FN': f"{PILE}/filtered_snv_fn.vcf.gz",
    'het-NULL': GERMLINE,
}
rows = []
...
json.dump(rows, open(f"{OUTDIR}/to_b2_scan_results.json", "w"), indent=1)
