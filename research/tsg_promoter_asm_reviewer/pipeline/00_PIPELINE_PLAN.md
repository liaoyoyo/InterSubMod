...
| **P2b cis-ladder + power** | `classify_cis_tier`（T0 NO-ASM→T3 cis-candidate，T0-T2 禁 causation 字眼）+ `power_class`（Wilcoxon 離散下限：DETECTED/NULL/UNDERPOWERED）| ✅ **完成** | BRCA2→**T3 + DETECTED**；het-null→T0/T1（P3 scan 全量驗）|
