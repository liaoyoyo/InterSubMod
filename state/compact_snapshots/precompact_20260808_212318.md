# PreCompact Snapshot — 20260808_212318 (trigger=auto)
...
```
 ...
 M docs/explain/01_background-glossary.standalone.html
 M docs/explain/02_ism-core.standalone.html
 M docs/explain/03_methylation-read-filter.standalone.html
 M docs/explain/04_subclone-reconstruction-chr2-18M.standalone.html
 M docs/explain/05_subclone-correction-audit-chr2-18M.standalone.html
 M docs/explain/06_ism-subclone-pipeline-concept.standalone.html
 M docs/explain/07_subclone-judgment-workstation-chr2-18M.standalone.html
 M docs/explain/08_subclone-logic-chain-chr2-18M.standalone.html
 M docs/explain/10_ism-cpp-vs-chr2-subclone-capability.standalone.html
 M docs/explain/index.standalone.html
 M docs/harness/HARNESS_FAILURE_LOG.md
...
?? docs/explain/11_system-map-overview.standalone.html
?? docs/explain/12_intersubmod-io.standalone.html
?? docs/explain/13_longlineage-io.standalone.html
?? docs/explain/14_upstream-data.standalone.html
?? docs/explain/15_python-html-layer.standalone.html
?? docs/explain/16_how-to-run.standalone.html
...
?? docs/postmortems/task_type_recall_202608.log
?? docs/superpowers/
?? state/compact_snapshots/precompact_20260807_162522.md
?? state/compact_snapshots/precompact_20260808_212318.md
?? tools/explain_page_qa.py
```
