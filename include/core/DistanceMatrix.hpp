...
public:
     ...
     */
    int size() const {
        return static_cast<int>(read_ids.size());
    }
     ...
     */
    void compute_from_methylation(const MethylationMatrix& methyl_mat, DistanceMetricType type, int min_cov,
     ...
     */
    void compute_from_methylation(const MethylationMatrix& methyl_mat, const DistanceConfig& config);
     ...
     */
    void compute_subset(const MethylationMatrix& methyl_mat, const std::vector<int>& row_indices,
                        DistanceMetricType type, int min_cov, NanDistanceStrategy nan_strategy);
...
public:
     ...
     */
    DistanceMatrix compute(const MethylationMatrix& methyl_mat, const std::vector<ReadInfo>& reads);
     ...
     */
    std::pair<DistanceMatrix, DistanceMatrix> compute_strand_specific(const MethylationMatrix& methyl_mat,
